...
class CustomerTest extends TestCase
{
    ...
    // {
    //     $customer = new Customer();
    //     $this->assertTrue( $customer->removeById(4));

   // }
    
   public function test_orm_create() {
        $customer = new Customer();
        $this->assertTrue($customer->create("Maasdsadootoonyan", "106 Norasdeles Ca, 91006"));
    }

    public function test_orm_updateById() {
        $customer = new Customer();
        $this->assertTrue($customer->updateById(7,"achaesaddl Haroanyan", "105 North St. Los Angeles Ca, 91006"));
    }
    ...
    // {
    //     $customer = new Customer();
    //     $results = $customer->where('id', '=', 4)->get(array('name', 'address'));
    ...
    // {
    //     $customer = new Customer();
    //     $results = $customer->where('id', '=', '4')->get();
    //     $this->assertEquals($results[0]->id, 4);
